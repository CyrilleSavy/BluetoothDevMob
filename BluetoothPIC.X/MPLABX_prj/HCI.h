...
typedef struct{
	...
	//unsigned char	data[];
        //Be sure that microchip compiler will understand good types
        WORD	info;		//connection handle & flags
	WORD	totalDataLen;
	BYTE	data[];
...
#define HCI_CMD_Write_Def_Link_Policy_Settings			0x000F	//set the link policy that the LM can use for a particular connection.
...
#define HCI_EVT_Link_Super_Timeout_Changed			0x38
